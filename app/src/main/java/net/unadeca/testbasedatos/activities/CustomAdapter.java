...
public class CustomAdapter extends ArrayAdapter<Arbolito>{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        viewHolder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(getContext(), "Se elimino el arbolito ", Toast.LENGTH_LONG).show();
    ...
    public void mostrarDialog(final Arbolito arbol){
        ...
        revision.getEditText().setText(arbol.fecha_ultima_revision);
                ...
                .setPositiveButton("Aceptar", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        try{
                            ...
                            guardarABD(altura, siembra,  revision,encargado, arbol);
                        }catch (Exception e){
